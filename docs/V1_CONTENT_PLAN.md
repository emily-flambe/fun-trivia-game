# V1 Content Plan — Trivia Trainer

Complete content target for V1, organized by Learned League's 18 categories. Informed by [TrivialStudies.com](https://www.trivialstudies.com/) coverage and LL question patterns.

**Philosophy**: Omnibus exercises that cover a topic broadly. Specialized sub-exercises (by era, by sport, by genre) come later as V2 refinements.

**Status legend**:
- ✅ **Done** — exercise exists in production
- 📋 **Ticketed** — Linear ticket exists (may be done or in backlog)
- ❌ **New** — needs a Linear ticket
...
|---|----------|--------|--------|-------|
| 1 | U.S. Presidents | 47 | ✅ | Fill-blanks ordered. All 47 presidents. |
| 2 | Constitutional Amendments | 27 | ✅ | All 27 amendments. |
...
| # | Exercise | ~Items | Status | Notes |
|---|----------|--------|--------|-------|
| 1 | Iconic Companies — Founders | 15 | ✅ | |
...
**Coverage**: 5/8 done. Remaining 3 exercises ticketed (EMI-395).
...
| # | Exercise | ~Items | Status | Notes |
|---|----------|--------|--------|-------|
| 1 | Best Picture Winners | 20 | ✅ | |
| 2 | Film Awards & Records | 12 | ✅ | |
...
| # | Exercise | ~Items | Status | Notes |
|---|----------|--------|--------|-------|
| 1 | World Cuisine — Signature Dishes | 15 | ✅ | |
| 2 | Wines & Wine Regions | 15 | ✅ | |
...
| # | Exercise | ~Items | Status | Notes |
|---|----------|--------|--------|-------|
| 1 | Legendary Athletes | 18 | ✅ | |
| 2 | Summer Olympic Host Cities | 18 | ✅ | |
| 3 | FIFA World Cup Winners | 22 | 📋 EMI-396 | TS has "All Olympics." Every winner since 1930. |
| 4 | Super Bowl Winners & MVPs | 20 | 📋 EMI-396 | TS has extensive Super Bowl coverage (winners, losers, MVPs). Omnibus. |
| 5 | World Series Winners | 20 | ❌ | TS has this. Notable winners, dynasties, memorable moments. |
| 6 | NBA Champions & MVPs | 20 | ❌ | TS has extensive NBA coverage. Omnibus of key winners. |
| 7 | Stanley Cup Winners | 15 | ❌ | TS has this. Key dynasties, notable years. |
| 8 | Tennis Grand Slams | 15 | 📋 EMI-396 | TS has "Tennis Trivia." Tournaments, all-time leaders, notable matches. |
| 9 | Golf Majors | 12 | ❌ | TS has "Golf Trivia." The four majors, all-time leaders. |
| 10 | Sports Venues & Stadiums | 15 | ❌ | TS has MLB/NBA/NFL/NHL/MLS stadiums. Omnibus of iconic venues. |
| 11 | Sports Rules & Terminology | 15 | 📋 EMI-396 | Offside, double fault, eagle, hat trick, etc. |
| 12 | Boxing & Combat Sports | 12 | ❌ | TS has "Boxing Trivia." Ali, Tyson, weight classes, famous fights. |
| 13 | Horse Racing Triple Crown | 10 | ❌ | TS has "Horse Racing Trivia." Kentucky Derby, Preakness, Belmont. Triple Crown winners. |
| 14 | College Sports & Rivalries | 15 | ❌ | TS has "NCAA Conferences", "NCAA Nicknames", "NCAA Rivalries." |
| 15 | Heisman Trophy Winners | 15 | ❌ | TS has this. Notable winners by year. |

**Coverage**: 2/15 done. Massive gap — TS shows sports is one of the deepest LL areas.
...
| # | Exercise | ~Items | Status | Notes |
|---|----------|--------|--------|-------|
| 1 | World Capitals — Major Countries | 40 | ✅ | |
| 2 | Countries of Africa | 54 | ✅ | Fill-blanks. |
| 3 | Countries of Europe | 45 | ✅ | Fill-blanks. |
| 4 | Landlocked Countries | 44 | ✅ | |
| 5 | World's Largest Countries by Area | 20 | ✅ | |
| 6 | Major World Rivers | 20 | ✅ | |
| 7 | Mountain Ranges & Peaks | 15 | ✅ | |
...
| 16 | Airport Codes (IATA) | 20 | ✅ 📋 EMI-420 | LAX, CDG, NRT, ORD, FCO, etc. |
...
| 19 | Former Country Names | 15 | ✅ 📋 EMI-420 | Siam→Thailand, Persia→Iran, Ceylon→Sri Lanka, etc. |
...
| 4 | NATO Phonetic Alphabet | 26 | ✅ 📋 EMI-420 | Fill-blanks ordered. All 26 code words. |
...
| 4 | Birthstones & Anniversary Gifts | 12 | ✅ 📋 EMI-419 | TS has both. January→garnet, 25th→silver, etc. |
...
| # | Exercise | ~Items | Status | Notes |
|---|----------|--------|--------|-------|
| 1 | Classic Novels — Author Matching | 35 | ✅ | |
| 2 | Greek & Roman Gods | 22 | ✅ | |
| 3 | Greek & Roman Mythology | 20 | ✅ | |
| 4 | Literary Characters | 24 | ✅ | |
| 5 | Nobel Prize in Literature | 15 | ✅ | |
| 6 | Famous Opening Lines | 15 | ✅ | |
...
| # | Exercise | ~Items | Status | Notes |
|---|----------|--------|--------|-------|
| 1 | Element Symbols (Periodic Table) | 118 | ✅ | |
| 2 | Noble Gases | 6 | ✅ | |
| 3 | Planets of the Solar System | 8 | ✅ | |
| 4 | Dwarf Planets | 5 | ✅ | |
| 5 | Biology & Taxonomy | 12 | ✅ | |
| 6 | Taxonomic Ranks | 8 | ✅ | |
| 7 | Earth Science Fundamentals | 10 | ✅ | |
| 8 | Layers of the Earth | 4 | ✅ | |
| 9 | Famous Scientists | 20 | ✅ | |
| 10 | Human Body Systems | 12 | ✅ | |
| 11 | Great Inventions | 15 | ✅ | |
| 12 | Notable Nobel Prize Winners | 19 | ✅ | |
| 13 | Physics Laws & Concepts | 15 | ✅ | |
| 14 | Animal Collective Nouns | 15 | ✅ 📋 EMI-420 | Murder of crows, pride of lions, parliament of owls. |
...
| 18 | Phobias | 15 | ✅ 📋 EMI-420 | Arachnophobia, claustrophobia, thalassophobia, etc. |
| 19 | Dog Breeds | 15 | ❌ | TS has this. AKC groups, notable breeds, origins. |
| 20 | Branches of Science | 12 | ✅ 📋 EMI-420 | Entomology, ornithology, dendrochronology, speleology. |
...
| # | Exercise | ~Items | Status | Notes |
|---|----------|--------|--------|-------|
| 1 | 20th Century World Events | 26 | ✅ | |
| 2 | Ancient Civilizations | 12 | ✅ | |
...
## Cross-Category / Special Exercises

Inspired by TrivialStudies' unique study tools:
...
4. **Theatre** — 1/5 (20%). Small but tested category.
5. **Classical Music** — 1/4 (25%). Niche but regularly tested.
6. **Language** — 2/5 (40%). Small but distinctive LL category.
7. **Art** — 2/5 (40%). Needs the actual artworks.
8. **American History** — 5/10 (50%). Solid foundation, needs breadth.
9. **Food/Drink** — 5/10 (50%). Good start, needs food items.
10. **World History** — 5/10 (50%). Needs monarchs/exploration.
11. **Current Events** — 1/3 (33%). Time-sensitive, limited scope.
12. **Business/Economics** — 5/8 (63%). Remaining 3 exercises ticketed (EMI-395).
13. **Geography** — 12/20 (60%). Most exercises but missing continents.
14. **Math** — 4/6 (67%). Niche LL category, already solid.
15. **Science** — 16/20 (80%). Well covered, needs fun trivia.
16. **Lifestyle** — 6/7 (86%). Nearly complete, only Zodiac Signs remaining.
17. **Literature** — 16/16 (100%). Complete.
18. **Film** — 10/10 (100%). Complete.
